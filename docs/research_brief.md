...
This project targets the intersection of **Recommender systems, IR, data mining, social media** and PhD-level research readiness. The goal is to produce a publishable-style artifact with a clear claim, reproducible experiments, and an honest account of failures.
...
2. Add one measurable method or evaluation contribution tied to James Caverlee's research area.
...
Advisor-specific slice: **Recommender systems, IR, data mining, social media**.
